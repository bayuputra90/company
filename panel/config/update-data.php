...
if ($image != 0) {
    ...
    $sql = "UPDATE tbl_team SET nama = '$nama', posisi = '$posisi', image = '$namaFile', email = '$email', username = '$username', password = '$password' where id = '$id'";
} else {

    $sql = "UPDATE tbl_team SET nama = '$nama', posisi = '$posisi', email = '$email', username = '$username', password = '$password' where id = '$id'";
